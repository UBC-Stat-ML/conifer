...
public class ExpFamMixture implements RateMatrixMixture
{
  ...
  @FactorArgument
  public final ExpFamRateParameters parameters;
...
//  }
  ...
  private ExpFamMixture(
      ExpFamRateParameters parameters,
  ...
  {
    // TODO: cache
    CTMCExpFam<CTMCState>.LearnedReversibleModel result = parameters.globalExponentialFamily.reversibleModelWithParameters(parameters.getWeights());
    return result;
  }
