...
public class RealVariableOverRelaxedSlice extends NodeMove
{
    ...
    public Pair<Double, Double> steppingOutInterval(Random rand, double auxVariable, double originalValue)
    {
    ...
    public double shrinkingSampling(double auxVariable, double originalValue, Pair<Double, Double> interval)
    {
