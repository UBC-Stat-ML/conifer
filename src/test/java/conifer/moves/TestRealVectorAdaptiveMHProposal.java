...
public class TestRealVectorAdaptiveMHProposal
{
    ...
    {
        new TestRealVectorAdaptiveMHProposal().test();
    }
    ...
    public void test()
    {
        File inputFile = new File("/Users/crystal/IdeaProjects/conifer/src/main/resources/conifer/sampleInput/FES_4.fasta");
        File treeFile = new File("/Users/crystal/IdeaProjects/conifer/src/main/resources/conifer/sampleInput/FES.ape.4.nwk");
